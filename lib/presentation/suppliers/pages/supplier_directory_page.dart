  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        heroTag: null,
        backgroundColor: AppColors.primary,
        onPressed: () => context.push(RouteNames.createMaster, extra: 2),
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: AppCard(
                    onTap: () => context.push(RouteNames.supplierDetails, extra: supplier),
                    child: Row(
                      ...
                      children: [
                        ...
                        PopupMenuButton<String>(
                          ...
                          onSelected: (val) {
                            if (val == 'edit') {
                              context.push(RouteNames.createMaster, extra: supplier);
                            }
                          },
